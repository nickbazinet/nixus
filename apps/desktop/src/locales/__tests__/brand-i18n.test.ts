...
// exact brand-cased forms; a case-insensitive sweep would also flag auth.promptTitle's
// "Nixus accounts", which is a separate flagged decision (Story 28.5, Task 4), not a regression.
